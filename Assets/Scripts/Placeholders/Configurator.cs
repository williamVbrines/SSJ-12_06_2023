...
namespace ssj12062023
{
    public class Configurator : MonoBehaviour, IDropHandler 
    {
        ...
        [SerializeField] private CardSlot behaviourMutationCardSlot;
        ...
        private readonly List<CardSlot> bodyMutationSlots = new();
            ...
            if (eventData.pointerDrag != null)
            {
                if (eventData.pointerDrag.TryGetComponent<BodyMutationCard>(out bodyMutationCard))
                {
                    ...
                    else
                    {
                        ...
                        foreach (CardSlot slot in bodyMutationSlots)
                        {
        ...
        private void GenerateCardSlots(int count)
        {
            ...
            {
                CardSlot slot = Instantiate<CardSlot>(cardSlotPrefab, bodyMutationsSlotsArea.transform);
